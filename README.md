...
[Get Paper In for Mac](https://paper-in.dev/) · [Releases and checksums](https://github.com/kellygold/paper-in/releases)

The 0.4.1 beta DMG is for Apple Silicon Macs running macOS 14 or later. Drag Paper In into Applications. Node and the provider runtimes are included. The download is Developer ID signed and notarized by Apple; see the [opening instructions](https://paper-in.dev/install.html). Other Mac architectures and scanner models are not yet verified.
