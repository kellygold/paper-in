  ...
  properties: {
    ...
    related: {
      ...
      items: {
        ...
        properties: {
          path: { type: 'string' },
          relationship: { type: 'string', enum: ['same_vendor', 'duplicate', 'continuation', 'uncertain'] },
          reason: { type: 'string' },
        },
